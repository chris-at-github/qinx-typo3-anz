<?php
namespace Qinx\Qxanz\ViewHelpers;
 ...
 * @api
 */
class NotViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractConditionViewHelper {

	/**
	 * renders <f:then> child if $condition is not true, otherwise renders <f:else> child.
	 *
